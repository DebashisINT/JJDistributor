package com.breezefieldjjscouts.features.nearbyshops.presentation
...
import com.breezefieldjjscouts.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezefieldjjscouts.app.utils.FTStorageUtils
import com.breezefieldjjscouts.app.utils.NotificationUtils
...
import com.breezefieldjjscouts.features.addshop.model.AssignedToShopListResponseModel
import com.breezefieldjjscouts.features.addshop.model.QuestionSubmit
import com.breezefieldjjscouts.features.addshop.model.UpdateAddrReq
import com.breezefieldjjscouts.features.addshop.model.UpdateAddressShop
...
import com.breezefieldjjscouts.features.addshop.presentation.*
...
import com.breezefieldjjscouts.features.location.model.ShopDurationRequestData
...
import com.breezefieldjjscouts.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezefieldjjscouts.features.marketing.model.MarketingCategoryListResponse
...
import com.breezefieldjjscouts.features.nearbyshops.model.StageListResponseModel
...
import com.breezefieldjjscouts.features.shopdetail.presentation.AddCollectionDialog
...
import com.breezefieldjjscouts.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezefieldjjscoutsApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
