package com.breezefieldjjscouts.features.logoutsync.presentation
...
import com.breezefieldjjscouts.CustomConstants
...
import com.breezefieldjjscouts.app.utils.Toaster
import com.breezefieldjjscouts.base.BaseResponse
import com.breezefieldjjscouts.base.presentation.BaseActivity
import com.breezefieldjjscouts.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldjjscouts.features.billing.api.AddBillingRepoProvider
import com.breezefieldjjscouts.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldjjscouts.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldjjscouts.features.document.model.AddEditDocumentInputParams
import com.breezefieldjjscouts.features.document.model.DocumentAttachmentModel
...
import com.breezefieldjjscouts.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefieldjjscouts.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefieldjjscouts.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldjjscouts.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldjjscouts.features.orderhistory.model.*
...
import com.breezefieldjjscouts.features.quotation.model.AddQuotInputModel
import com.breezefieldjjscouts.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldjjscouts.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldjjscouts.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldjjscouts.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldjjscouts.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefieldjjscouts.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldjjscouts.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldjjscouts.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldjjscouts.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldjjscouts.mappackage.SendBrod
import com.breezefieldjjscouts.widgets.AppCustomTextView
import com.breezefieldjjscouts.MonitorService
import com.breezefieldjjscouts.MySingleton
import com.breezefieldjjscouts.app.AlarmReceiver
...
import com.breezefieldjjscouts.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldjjscouts.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldjjscouts.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldjjscouts.features.orderITC.SyncDeleteOpptL
import com.breezefieldjjscouts.features.orderITC.SyncEditOppt
import com.breezefieldjjscouts.features.orderITC.SyncOppt
import com.breezefieldjjscouts.features.orderITC.SyncOpptProductL
import com.breezefieldjjscouts.features.orderITC.SyncOrd
import com.breezefieldjjscouts.features.orderITC.SyncOrdProductL
import com.breezefieldjjscouts.features.performance.model.Gps_status_list
import com.breezefieldjjscouts.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldjjscouts.features.returnsOrder.ReturnProductList
import com.breezefieldjjscouts.features.returnsOrder.ReturnRequest
import com.breezefieldjjscouts.features.viewAllOrder.model.NewOrderSaveApiModel
import com.breezefieldjjscouts.features.viewAllOrder.model.NewStockSync
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezefieldjjscouts/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldjjscoutslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldjjscoutslogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldjjscoutslogsample/log.zip").path);
