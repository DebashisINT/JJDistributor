package com.breezefieldjjscouts.features.dashboard.presentation
...
import com.breezefieldjjscouts.*
import com.breezefieldjjscouts.R
import com.breezefieldjjscouts.app.*
import com.breezefieldjjscouts.app.NewFileUtils.browseDocuments
import com.breezefieldjjscouts.app.NewFileUtils.browsePDFDocuments
import com.breezefieldjjscouts.app.NewFileUtils.getExtension
import com.breezefieldjjscouts.app.domain.*
import com.breezefieldjjscouts.app.types.DashboardType
import com.breezefieldjjscouts.app.types.FragType
import com.breezefieldjjscouts.app.types.TopBarConfig
import com.breezefieldjjscouts.app.uiaction.DisplayAlert
import com.breezefieldjjscouts.app.utils.*
import com.breezefieldjjscouts.app.utils.AppUtils.Companion.isProfile
...
import com.breezefieldjjscouts.features.NewQuotation.*
import com.breezefieldjjscouts.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldjjscouts.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldjjscouts.features.SearchLocation.SearchLocationFragment
import com.breezefieldjjscouts.features.SearchLocation.locationInfoModel
import com.breezefieldjjscouts.features.TA.ViewAllTAListFragment
import com.breezefieldjjscouts.features.achievement.AchievementFragment
import com.breezefieldjjscouts.features.activities.presentation.*
import com.breezefieldjjscouts.features.addAttendence.*
import com.breezefieldjjscouts.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldjjscouts.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldjjscouts.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldjjscouts.features.addAttendence.model.GetReportToResponse
import com.breezefieldjjscouts.features.addAttendence.model.Leave_list_Response
import com.breezefieldjjscouts.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldjjscouts.features.addshop.presentation.AddShopFragment
import com.breezefieldjjscouts.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldjjscouts.features.addshop.presentation.ScanImageFragment
import com.breezefieldjjscouts.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldjjscouts.features.alarm.model.AlarmData
import com.breezefieldjjscouts.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldjjscouts.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldjjscouts.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldjjscouts.features.alarm.presetation.VisitReportFragment
import com.breezefieldjjscouts.features.attendance.AttendanceFragment
import com.breezefieldjjscouts.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldjjscouts.features.attendance.model.AttendanceRequest
import com.breezefieldjjscouts.features.attendance.model.AttendanceResponse
import com.breezefieldjjscouts.features.averageshop.presentation.AverageShopFragment
import com.breezefieldjjscouts.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldjjscouts.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldjjscouts.features.beatCustom.TeamBeatListFragment
import com.breezefieldjjscouts.features.billing.presentation.AddBillingFragment
import com.breezefieldjjscouts.features.billing.presentation.BillingDetailsFragment
import com.breezefieldjjscouts.features.billing.presentation.BillingListFragment
import com.breezefieldjjscouts.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldjjscouts.features.chat.model.ChatListDataModel
import com.breezefieldjjscouts.features.chat.model.ChatUserDataModel
import com.breezefieldjjscouts.features.chat.model.GroupUserDataModel
import com.breezefieldjjscouts.features.chat.presentation.*
import com.breezefieldjjscouts.features.chatbot.presentation.ChatBotFragment
import com.breezefieldjjscouts.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldjjscouts.features.chatbot.presentation.ReportsFragment
import com.breezefieldjjscouts.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldjjscouts.features.commondialog.presentation.CommonDialog
import com.breezefieldjjscouts.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldjjscouts.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldjjscouts.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldjjscouts.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldjjscouts.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldjjscouts.features.contacts.ActivityDtlsFrag
import com.breezefieldjjscouts.features.contacts.AddOpptFrag
import com.breezefieldjjscouts.features.contacts.ContactDtls
import com.breezefieldjjscouts.features.contacts.ContactGr
import com.breezefieldjjscouts.features.contacts.ContactsAddFrag
import com.breezefieldjjscouts.features.contacts.ContactsFrag
import com.breezefieldjjscouts.features.contacts.SchedulerAddFormFrag
import com.breezefieldjjscouts.features.contacts.SchedulerViewFrag
import com.breezefieldjjscouts.features.contacts.TemplateAddFrag
import com.breezefieldjjscouts.features.contacts.TemplateViewFrag
import com.breezefieldjjscouts.features.contacts.ViewCrmOpptFrag
import com.breezefieldjjscouts.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldjjscouts.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldjjscouts.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldjjscouts.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldjjscouts.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldjjscouts.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldjjscouts.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldjjscouts.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldjjscouts.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldjjscouts.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldjjscouts.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldjjscouts.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldjjscouts.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldjjscouts.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldjjscouts.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldjjscouts.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldjjscouts.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldjjscouts.features.document.presentation.DocumentListFragment
import com.breezefieldjjscouts.features.document.presentation.DocumentTypeListFragment
import com.breezefieldjjscouts.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldjjscouts.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldjjscouts.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldjjscouts.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldjjscouts.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldjjscouts.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldjjscouts.features.home.presentation.HomeFragment
import com.breezefieldjjscouts.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldjjscouts.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldjjscouts.features.know_your_state.KnowYourStateFragment
import com.breezefieldjjscouts.features.lead.LeadFrag
import com.breezefieldjjscouts.features.lead.ViewLeadFrag
import com.breezefieldjjscouts.features.leaderboard.LeaderBoardFrag
import com.breezefieldjjscouts.features.leaveapplynew.LeaveHome
import com.breezefieldjjscouts.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldjjscouts.features.localshops.LocalShopListFragment
import com.breezefieldjjscouts.features.localshops.LocalShopListMapFragment
import com.breezefieldjjscouts.features.localshops.NearByShopsMapFragment
import com.breezefieldjjscouts.features.location.*
import com.breezefieldjjscouts.features.location.api.LocationRepoProvider
import com.breezefieldjjscouts.features.location.model.*
import com.breezefieldjjscouts.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldjjscouts.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldjjscouts.features.login.ShopFeedbackEntity
import com.breezefieldjjscouts.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldjjscouts.features.login.presentation.LoginActivity
import com.breezefieldjjscouts.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldjjscouts.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldjjscouts.features.marketAssist.MarketAssistTabFrag
import com.breezefieldjjscouts.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldjjscouts.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldjjscouts.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldjjscouts.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldjjscouts.features.member.MapViewForTeamFrag
import com.breezefieldjjscouts.features.member.model.TeamLocDataModel
import com.breezefieldjjscouts.features.member.model.TeamShopListDataModel
import com.breezefieldjjscouts.features.member.presentation.*
import com.breezefieldjjscouts.features.menuBeat.MenuBeatFrag
import com.breezefieldjjscouts.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldjjscouts.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldjjscouts.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldjjscouts.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldjjscouts.features.myjobs.model.CustomerDataModel
import com.breezefieldjjscouts.features.myjobs.presentation.*
import com.breezefieldjjscouts.features.mylearning.MyLearningFragment
import com.breezefieldjjscouts.features.myorder.presentation.MyOrderListFragment
import com.breezefieldjjscouts.features.myprofile.presentation.MyProfileFragment
import com.breezefieldjjscouts.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefieldjjscouts.features.nearbyshops.model.ShopData
import com.breezefieldjjscouts.features.nearbyshops.model.ShopListResponse
import com.breezefieldjjscouts.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldjjscouts.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldjjscouts.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldjjscouts.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldjjscouts.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldjjscouts.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldjjscouts.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldjjscouts.features.newcollection.CollectionShopListFragment
import com.breezefieldjjscouts.features.newcollection.NewCollectionListFragment
import com.breezefieldjjscouts.features.newcollectionreport.*
import com.breezefieldjjscouts.features.notification.NotificationFragment
import com.breezefieldjjscouts.features.orderITC.CartListFrag
import com.breezefieldjjscouts.features.orderITC.OrderListFrag
import com.breezefieldjjscouts.features.orderITC.ProductListFrag
import com.breezefieldjjscouts.features.orderITC.ViewNewOrdHisAllFrag
import com.breezefieldjjscouts.features.orderITC.ViewNewOrdHistoryFrag
import com.breezefieldjjscouts.features.orderITC.ViewOrdDtls
import com.breezefieldjjscouts.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldjjscouts.features.orderList.NewOrderListFragment
import com.breezefieldjjscouts.features.orderList.OrderListFragment
import com.breezefieldjjscouts.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldjjscouts.features.orderhistory.ActivityMapFragment
import com.breezefieldjjscouts.features.orderhistory.OrderhistoryFragment
import com.breezefieldjjscouts.features.orderhistory.TimeLineFragment
import com.breezefieldjjscouts.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezefieldjjscouts.features.orderhistory.model.LocationData
import com.breezefieldjjscouts.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldjjscouts.features.performance.GpsStatusFragment
import com.breezefieldjjscouts.features.performance.PerformanceFragment
import com.breezefieldjjscouts.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefieldjjscouts.features.performance.model.UpdateGpsInputParamsModel
import com.breezefieldjjscouts.features.performanceAPP.OwnPerformanceFragment
import com.breezefieldjjscouts.features.performanceAPP.PerformanceAppFragment
import com.breezefieldjjscouts.features.performanceAPP.allPerformanceFrag
import com.breezefieldjjscouts.features.permissionList.ViewPermissionFragment
import com.breezefieldjjscouts.features.photoReg.*
import com.breezefieldjjscouts.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldjjscouts.features.quotation.presentation.*
import com.breezefieldjjscouts.features.reimbursement.presentation.*
import com.breezefieldjjscouts.features.report.presentation.*
import com.breezefieldjjscouts.features.returnsOrder.*
import com.breezefieldjjscouts.features.settings.presentation.SettingsFragment
import com.breezefieldjjscouts.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldjjscouts.features.shopdetail.presentation.*
import com.breezefieldjjscouts.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldjjscouts.features.stock.StockDetailsFragment
import com.breezefieldjjscouts.features.stock.StockListFragment
import com.breezefieldjjscouts.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldjjscouts.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldjjscouts.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldjjscouts.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldjjscouts.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldjjscouts.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldjjscouts.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldjjscouts.features.survey.SurveyFrag
import com.breezefieldjjscouts.features.survey.SurveyViewDtlsFrag
import com.breezefieldjjscouts.features.survey.SurveyViewFrag
import com.breezefieldjjscouts.features.task.presentation.AddTaskFragment
import com.breezefieldjjscouts.features.task.presentation.CalenderTaskFragment
import com.breezefieldjjscouts.features.task.presentation.EditTaskFragment
import com.breezefieldjjscouts.features.task.presentation.TaskListFragment
import com.breezefieldjjscouts.features.taskManagement.TaskManagementFrag
import com.breezefieldjjscouts.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldjjscouts.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldjjscouts.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldjjscouts.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldjjscouts.features.viewAllOrder.CartFragment
import com.breezefieldjjscouts.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldjjscouts.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldjjscouts.features.viewAllOrder.ViewCartFragment
import com.breezefieldjjscouts.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldjjscouts.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldjjscouts.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldjjscouts.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldjjscouts.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldjjscouts.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldjjscouts.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldjjscouts.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldjjscouts.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldjjscouts.features.viewPPDDStock.ViewStockFragment
import com.breezefieldjjscouts.features.weather.presentation.WeatherFragment
import com.breezefieldjjscouts.mappackage.MapActivity
import com.breezefieldjjscouts.mappackage.MapActivityWithoutPath
import com.breezefieldjjscouts.mappackage.SendBrod
import com.breezefieldjjscouts.widgets.AppCustomEditText
...
import com.breezefieldjjscouts.features.login.api.opportunity.OpportunityRepoProvider
import com.breezefieldjjscouts.features.login.model.NewSettingsResponseModel
import com.breezefieldjjscouts.features.mylearning.AllTopicsWiseContents
import com.breezefieldjjscouts.features.mylearning.BookmarkFetchResponse
import com.breezefieldjjscouts.features.mylearning.BookmarkFrag
import com.breezefieldjjscouts.features.mylearning.BookmarkPlayFrag
import com.breezefieldjjscouts.features.mylearning.InCorrectQuesAnsFrag
import com.breezefieldjjscouts.features.mylearning.KnowledgeHubAllVideoList
import com.breezefieldjjscouts.features.mylearning.LeaderboardLmsFrag
import com.breezefieldjjscouts.features.mylearning.LmsQuestionAnswerSet
import com.breezefieldjjscouts.features.mylearning.MyLearningAllVideoList
import com.breezefieldjjscouts.features.mylearning.MyLearningTopicList
import com.breezefieldjjscouts.features.mylearning.MyLearningVideoPlay
import com.breezefieldjjscouts.features.mylearning.MyPerformanceFrag
import com.breezefieldjjscouts.features.mylearning.MyTopicsWiseContents
import com.breezefieldjjscouts.features.mylearning.MyTopicsWiseContents.Companion.topic_id
import com.breezefieldjjscouts.features.mylearning.MyTopicsWiseContents.Companion.topic_name
import com.breezefieldjjscouts.features.mylearning.NotificationLMSFragment
import com.breezefieldjjscouts.features.mylearning.RetryIncorrectQuizFrag
import com.breezefieldjjscouts.features.mylearning.RetryPlayFrag
import com.breezefieldjjscouts.features.mylearning.RetryQuestionFrag
import com.breezefieldjjscouts.features.mylearning.SearchLmsFrag
import com.breezefieldjjscouts.features.mylearning.SearchLmsKnowledgeFrag
import com.breezefieldjjscouts.features.mylearning.SearchLmsLearningFrag
import com.breezefieldjjscouts.features.mylearning.VideoPlayLMS
import com.breezefieldjjscouts.features.mylearning.apiCall.LMSRepoProvider
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldjjscoutslogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldjjscoutslogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezefieldjjscouts/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezefieldjjscoutslogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezefieldjjscoutslogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezefieldjjscoutslogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
