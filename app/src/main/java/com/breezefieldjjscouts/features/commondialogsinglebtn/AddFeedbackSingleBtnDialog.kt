package com.breezefieldjjscouts.features.commondialogsinglebtn
...
import com.breezefieldjjscouts.app.domain.ShopVisitCompetetorModelEntity
import com.breezefieldjjscouts.app.domain.VisitRemarksEntity
...
import com.breezefieldjjscouts.features.addshop.presentation.ProspectListDialog
import com.breezefieldjjscouts.features.dashboard.presentation.DashboardActivity
import com.breezefieldjjscouts.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezefieldjjscouts.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezefieldjjscouts/files", "recorded_audio${System.currentTimeMillis()}.mp3")
